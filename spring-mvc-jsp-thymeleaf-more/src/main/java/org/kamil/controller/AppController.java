...
public class AppController {
	...
	public String loopExample(Model model) {
		model.addAttribute("books",
				Arrays.asList(new Book("Książka 1", "Autor 1", 59.99), new Book("Książka 2", "Autor 2", 69.99),
						new Book("Książka 3", "Autor 3", 79.99), new Book("Książka 4", "Autor 4", 89.99),
						new Book("Książka 5", "Autor 5", 99.99), new Book("Książka 6", "Autor 6", 19.99)));
		return "loop";
	}
